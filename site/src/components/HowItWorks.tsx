...
const steps = [
  {
    num: '01',
    title: 'Say it — or don\'t',
    desc: 'Ask by voice or text. Or let Persona suggest based on your calendar, habits, and location — it thinks ahead so you don\'t have to.',
    icon: (
  ...
  },
  {
    num: '02',
    title: 'Approve it',
    desc: 'One tap. Full price breakdown, no hidden fees. Nothing moves without your say-so.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    num: '03',
    title: 'Get it',
    desc: 'Persona browses the store, adds to cart, checks out, and tracks delivery. You just wait for the doorbell.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
